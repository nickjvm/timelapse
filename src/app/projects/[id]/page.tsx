    ...
    <DndContext sensors={sensors} collisionDetection={closestCenter} onDragEnd={handleDragEnd}>
      <div className="h-full pb-36" onClick={(e) => {
        ...
        <Header
          ...
          buttons={[
            <button key="delete" className=" bg-white text-red-800 hover:bg-white hover:underline text-sm" onClick={handleDelete}>
              Delete
            </button>,
            <button key="play" className=" bg-blue-500 text-white hover:bg-blue-800" onClick={() => setPreview(true)}>
              <PiPlayFill /> Play
            </button>
          ]}
        />
