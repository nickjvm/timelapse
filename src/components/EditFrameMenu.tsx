...
export default function EditFrameMenu({
  ...
  return (
    <Menu>
      <MenuButton
        ref={menuButtonRef}
        className="z-60 border border-white bg-white/50 !rounded-full !p-3 hover:bg-white/75 transition-colors"
      >
      ...
      >
        ...
        <MenuItem>
          <button
            onClick={() => setAlterationType("rotate")}
        ...
        <MenuItem>
          <button
            onClick={() => setAlterationType("zoom")}
        ...
        <MenuItem>
          <button
            onClick={handleReset}
            className="hover:bg-white hover:text-red-800"
          >
